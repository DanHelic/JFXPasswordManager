...
public class AddPasswordPane extends BorderPane {

    boolean showPasswordBoolean, showPWNotSame;
    ...
    public AddPasswordPane(Stage s, File prof, String pPw){
        ...
        descriptionString ="";
        stage=s;
        picFile = new File("Pictures/NoProfilePic.png");
        genLength="12";
        profileFile = prof;
        profilePw=pPw;
        showPWNotSame =false;
    ...
    void paintIt(){
        ...
        Button addPwB = new Button(lang.getText(34));
        ...
        pwNotSameErrorL.setVisible(showPWNotSame);
        ...
        addPwB.setOnAction(e->{ //no errors yet
            if(pw1TF.getText().equals(pw2TF.getText())){
                picFile = new File (settingFile.picFolder+ioS.checkIfNewPic(picFile));
                ioS.addPassword(usernameTF.getText(), pw1TF.getText(), descriptionTA.getText(), picFile.getName(), profileFile,profilePw);
